  ...
  test("POST /transactions", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        transactionTimestamp: CREATE_RESULT.transactionTimestamp.toISOString(),
      ...
      .expect([
        {
          ...
          transactionTimestamp:
            FIND_MANY_RESULT[0].transactionTimestamp.toISOString(),
  ...
  test("GET /transactions/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        transactionTimestamp:
          FIND_ONE_RESULT.transactionTimestamp.toISOString(),
