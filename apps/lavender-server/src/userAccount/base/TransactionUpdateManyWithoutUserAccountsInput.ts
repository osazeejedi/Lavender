...
@InputType()
class TransactionUpdateManyWithoutUserAccountsInput {
...
export { TransactionUpdateManyWithoutUserAccountsInput as TransactionUpdateManyWithoutUserAccountsInput };
