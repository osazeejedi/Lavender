...
@InputType()
class UserAchievementCreateNestedManyWithoutAchievementsInput {
...
export { UserAchievementCreateNestedManyWithoutAchievementsInput as UserAchievementCreateNestedManyWithoutAchievementsInput };
