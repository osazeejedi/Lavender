...
@InputType()
class UserAchievementCreateNestedManyWithoutUsersInput {
...
export { UserAchievementCreateNestedManyWithoutUsersInput as UserAchievementCreateNestedManyWithoutUsersInput };
