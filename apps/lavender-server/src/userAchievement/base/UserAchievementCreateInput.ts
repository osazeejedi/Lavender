...
@InputType()
class UserAchievementCreateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => UserAchievementCreateNestedManyWithoutUserAchievementsInput,
  })
  @ValidateNested()
  @Type(() => UserAchievementCreateNestedManyWithoutUserAchievementsInput)
  @IsOptional()
  @Field(() => UserAchievementCreateNestedManyWithoutUserAchievementsInput, {
    nullable: true,
  })
  userAchievements?: UserAchievementCreateNestedManyWithoutUserAchievementsInput;
}

export { UserAchievementCreateInput as UserAchievementCreateInput };
